...
export declare class ResttyWasm {
    ...
    getSelectionText(handle: number, anchorRow: number, anchorCol: number, focusRow: number, focusCol: number): string;
    ...
    getMode(handle: number, mode: number, ansi?: boolean): boolean | undefined;
    /**
